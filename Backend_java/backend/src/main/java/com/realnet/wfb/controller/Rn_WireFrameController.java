...
//	}
	...
	public ResponseEntity<?> saveWireFrame(@Valid @RequestBody Rn_WireFrameDTO wireframeDTO, HttpSession session)
		...
		Rn_Fb_Header fb = wireframeService.saveWireframe(wireframeDTO, wireframeDTO.getFormType(),
				wireframeDTO.getModuleId());
...
//	@DeleteMapping(value = "/wireframe-delete-field/{id}")
...
//	}
	...
	// delete wireframe header
	@DeleteMapping(value = "/wireframe_delete_header/{id}")
	public ResponseEntity<?> deleteheaderbyid(@PathVariable("id") Integer id) throws IOException { // this is
																									// rn_fb_header ID
		boolean status = wireframeService.deleteheaderbyid(id);
		if (status) {
			SuccessPojo successPojo = new SuccessPojo();
			Success success = new Success();
			success.setTitle(Constant.WIREFRAME_API_TITLE);
...
//	}
	...
	public ResponseEntity<?> uinamechange(@PathVariable("id") Integer id, @Valid @RequestBody Rn_Fb_HeaderDTO uiname)
			throws IOException { // this is rn_fb_header ID
...
//		}
	...
	// ..............................................change below code is not
	// working

	@PutMapping("/headerupdate/{id}")
	public ResponseEntity<Rn_Fb_Header> updateHeader(@PathVariable(value = "id") int id,
			@RequestBody Rn_Fb_Header headerRequest) {

		Rn_Fb_Header updatedHeader = wireframeService.updateById(id, headerRequest);
