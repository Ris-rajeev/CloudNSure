...
import com.realnet.bugTracker.Helper.Fileuploadhelper;
...
public class BugTrackerController {
	...
	public ResponseEntity<String> createIssue(@RequestParam String data, @RequestParam MultipartFile file)
		...
		if (!file.isEmpty()) {
			...
			boolean isUploaded = fileuploadhelper.uploadFile(file) != null;
	...
	public ResponseEntity<String> updateIssue(@RequestParam String data, @PathVariable Long id,
		...
		if (!file.isEmpty()) {
			System.out.println(file.getOriginalFilename());
			boolean f = fileuploadhelper.uploadFile(file) != null;
